...
클러스터생성은 원하는 EC2 타입을 정하고 키페어를 설정하고 생성한다. EC2 R과 M 타입 & 5.1x 이하 버전에서는 EMR Notebook을 사용할 수 없으니 참고하여 생성한다.__
클러스터가 시작에서 대기가 되면 클러스터가 제대로 작동할 준비를 마친 것이니 사용해도 된다.__
Notebook을 사용하기 위해서는 클러스터 생성시 고급설정에 들어가서 Jupyter관련 어플리케이션을 모두 깔아야 한다.__
